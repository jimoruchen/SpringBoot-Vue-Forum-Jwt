...
function handleClick1() {
    window.open('https://ehall.nnu.edu.cn/new/index.html?browser=no&eqid=b3baa2790002ba2400000004645f0745', '_blank');
}
                    ...
                    <el-scrollbar style="height: calc(100vh - 55px)">
                        <el-menu
                            ...
                            <el-sub-menu index="1">
                                ...
                                <el-menu-item index="/index/like-setting">
                                    <template #title>
                                        <el-icon>
                                            <View/>
                                        </el-icon>
                                ...
                                <el-menu-item index="/index/activity-setting">
                                    <template #title>
                                        <el-icon>
                                            <Football/>
                                        </el-icon>
                                ...
                                <el-menu-item index="/index/love-setting">
                                    <template #title>
                                        <el-icon>
                                            <Umbrella/>
                                        </el-icon>
                                ...
                                <el-menu-item @click="handleClick">
                                    <template #title>
                                        ...
                                        和风天气
                                        <el-tag style="margin-left: 10px" size="small">技术支持</el-tag>
                                    </template>
                                </el-menu-item>
                            ...
                            <el-sub-menu index="2">
                                ...
                                <el-menu-item @click="handleClick1">
                                    <template #title>
                                        <el-icon>
                                            <Document/>
                                        </el-icon>
                                ...
                                <el-menu-item index="/index/notice-setting">
                                    <template #title>
                                        <el-icon>
                                            <DataBoard/>
                                        </el-icon>
                                ...
                                <el-menu-item index="/index/competition-setting">
                                    <template #title>
                                        <el-icon>
                                            <Monitor/>
                                        </el-icon>
