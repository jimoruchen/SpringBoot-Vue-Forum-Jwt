...
function updateList() {
    ...
    get(`/api/forum/list_topic?page=${topics.page}&type=${topics.type}`, data => {
        if(data) {
...
navigator.geolocation.getCurrentPosition(position => {
    ...
    console.info(error)
    get(`/api/forum/weather?longitude=118.92&latitude=32.10`, data => {
        Object.assign(weather, data)
        weather.success = true
    })
}, {
...
function handleClick1() {
    window.open('https://spring.p2hp.com/', '_blank');
}
function handleClick2() {
    window.open('https://element-plus.gitee.io/zh-CN/', '_blank');
}
</script>
    ...
    <div style="display: flex;margin: 20px auto;gap: 20px;max-width: 900px">
        <div style="flex: 1">
            ...
            <light-card style="margin-top: 10px;display: flex;gap: 7px">
                <div
                    v-for="(item, index) in store.forum.types.slice(0, 5)"
                    :key="index"
            ...
            <div style="position: sticky;top: 20px">
                ...
                <light-card style="margin-top: 10px">
                    ...
                    <div style="font-size: 14px;margin: 10px;color: grey">
                        史上最大开源LLM，参数高达3140亿！马斯克如约开源Grok，10小时狂揽10000颗Star随着生成式人工智能发展，“一个新的产业已经出现”，马斯克的xAI公司开源 Grok-1，高达 3140 亿参数，
                ...
                <div style="display: grid;grid-template-columns: repeat(2, 1fr);grid-gap: 10px;margin-top: 10px">
                    <div class="friend-link" @click="handleClick1">
                        <el-image style="height: 90px" src="https://s2.loli.net/2024/05/09/UwaOKEMJDIy6C5g.png"/>
                    </div><div class="friend-link" @click="handleClick2">
                        <el-image style="height: 90px" src="https://s2.loli.net/2024/05/09/RfJAY45x1Gkaryq.png"/>
                    </div>
                </div>
            </div>
        </div>
